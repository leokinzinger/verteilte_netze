...
int marshal_control_message(int socketcm, control_message * out_control){
    ...
    buf[0]=(out_control->con<<7)|(out_control->reserved<<5)|(out_control->join<<4)|(out_control->notify<<3)|(out_control->stabilize<<2)|(out_control->reply<<1)|out_control->lookup;
